...
const Google = ({ iconFill = '#5758BB' }: GoogleProps) => {
   return (
    ...
    //           fill="#4285F4" p-id="2441"></path>
    //    </svg>
    <GoogleLogin
    clientId="ykqviXRQwXNaHvtw.apps.googleusercontent.com"  // change to your Google API
